...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('transaksi', function (Blueprint $table) {
            ...
            // Ini adalah kolom untuk menyimpan nomor WhatsApp pembeli dengan panjang maksimal 20 karakter
            $table->string('no_wa_pembeli',20);
            ...
            $table->string('total_pembelian', 150);
